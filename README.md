...
- The forward compatibility direction is **stock addon JAR + HeroClock**: generic safe optimizations stay in HeroClock's runtime layer, while version-gated addon adapters may redirect known hotspots through HeroClock deadlines, bounded work, cleanup, or sync-deduplication systems without rewriting the addon JAR.
